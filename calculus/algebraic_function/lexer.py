##### begin lexer.py ###########################################################
import re # TODO: replace tokenizer with a generator in lexer class without RegEx


from .algebraic_function_grammar import calculation_operator_dict, linking_operator_dict, linking_operator_order, bracket_operators
...
# returns a list of all the declared Operators sorted by length starting with the longest
def all_operators():
