"""Defines the overall usage of the AlgebraicFunction interface-class."""
...
class AlgebraicFunction(metaclass=AlgebraicFunctionMeta):
    ...
    def simplify(self):
        """
        Instancemethod that tries to simplify the given object by checking if
        it contains a parameter. Usually invoked by a derived class through
...
from .algebraic_function_grammar import (
    Constant,
    Parameter,
    Addition,
    Subtraction,
